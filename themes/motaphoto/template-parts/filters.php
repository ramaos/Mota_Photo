        ...
        <div class="filter__select">
            <select id="category-select" class="select filter__select--categorie" name="category">
                ...
                foreach ($categories as $categorie) :
                    ...
                    echo '<option class="select-categorie" value="' . esc_attr($categorie->slug) . '" ' . $selected . '>' . esc_html($categorie->name) . '</option>';
                endforeach;
                ?>
            </select>
            <select id="format-select" class="select filter__select--format" name="format">
                ...
                foreach ($formats as $format) :
                    ...
                    echo '<option class="select-format" value="' . esc_attr($format->slug) . '" ' . $selected . '>' . esc_html($format->name) . '</option>';
                endforeach;
                ?>
            </select>
        </div>
